...
{
    /// <inheritdoc />
    public partial class InitialInventoryPersistence : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AvailableQuantity = table.Column<decimal>(type: "numeric(19,4)", precision: 19, scale: 4, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_stock_movements_ProductId_OperationKey",
                table: "stock_movements",
                columns: new[] { "ProductId", "OperationKey" },
                unique: true);
        }
